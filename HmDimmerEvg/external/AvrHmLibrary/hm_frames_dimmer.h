...
#define HM_FRM_DIMMER_SET_NEW(frm_buf_tgt,frm_dst_addr) \
	INIT_HM_MSG_TRUNK((frm_buf_tgt), 16, ++hm_msgctr, 0xa011, (frm_dst_addr)); \
...
typedef struct {
	...
	uint8_t state_flags;
//	uint8_t rssi;
} hmmsg_dimmer_info_level_t;

#define HM_MSG_DEVICE hmmsg_dimmer_info_level_t dimmer_info_level; hmmsg_dimmer_level_set_t dimmer_set;
